...
// @todo faire un tri la dedans car possible que une seule interface suffise
...
export function compileSettingsForScreenSize(
    settings: SliderSettings, screenSize: number, ElementScrolable: number): CompiledSettings {
...
export function getScrollPositionForItem(item: number, settings: CompiledSettings): number {
